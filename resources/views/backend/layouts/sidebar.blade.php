         ...
         <div class="sidebar-content">
             <div class="user">
                 <div class="avatar-sm float-left mr-2">
                     ...
                     @else
                         <img src="{{ url('uploads/Foto Profile User') }}/{{ Auth::user()->foto_profile }}" alt="..."
             ...
             <ul class="nav nav-primary">
                 ...
                 @if (Request::url() === route('toko.listToko') || Request::url() === route('toko.tambahToko'))
                     <div class="show collapse" id="base">
                     @else
         ...
         <div class="modal-content">
             ...
             <div class="modal-footer mt-2">
                 <button type="button" class="btn btn-danger btn-close btn-sm" data-bs-dismiss="modal"
                     arial-label="Close"><i class="fas fa-fw fa-times"></i> Tutup</button>
             </div>
         </div>
     </div>
 </div>
         ...
         <div class="modal-content">
             <form class="" id="formActionEditUser" method="POST">
                             ...
                             <div class="form-group mt-2">
                                 <div class="row">
                                     <div class="col">
                                         ...
                                         <input type="file" class="form-control" id="email2" placeholder=""
                                             name="foto_profile">
                                     </div>
                                     <div class="col">
                 ...
                 <div class="modal-footer mt-2">
                     <button type="button" class="btn btn-danger btn-close btn-sm" data-bs-dismiss="modal"
                         arial-label="Close"><i class="fas fa-fw fa-times"></i> Tutup</button>
                     <button type="submit" class="btn btn-success btn-save btn-sm" data-bs-dismiss="modal"
                         arial-label="Close"><i class="fas fa-fw fa-save"></i> Simpan</button>
                 </div>
             </form>
         </div>
     </div>
