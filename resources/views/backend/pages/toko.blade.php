                            ...
                            <div class="reloadTable">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        {{-- @csrf --}}
                                        <table id="basic-datatables" class="table-hover tabelToko table">
                                            <thead>
                                                <tr>
                                                    <th>No</th>
                                                    <th>Nama Toko</th>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($daftarTokoSaya as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="avatar">
                                                                <img src="{{ url('uploads/Foto Sampul Toko/') }}/{{ $item->sampul_toko }}"
                                                                    alt="..." class="avatar-img rounded">
                                                            </div>
                                                        </td>
                                                        <td width="30px">
                                                            <div class="form-button-action">
                                                                <a href="{{ url('detail-toko', $item->id) }}" type="button"
                                                                    data-toggle="tooltip" title="Detail Toko"
                                                                    class="btn btn-link btn-success"
                                                                    data-original-title="Edit Task"
                                                                    data-id="{{ $item->id }}" data-jenis="detail">
                                                                    <i class="fa fa-lg fa-eye"></i>
                                                                </a>
                                                                <a href="{{ url('edit-toko', $item->id) }}" type="button"
                                                                    data-toggle="tooltip" title="Ubah Toko"
                                                                    class="btn btn-link btn-primary"
                                                                    data-original-title="Edit Task"
                                                                    data-id="{{ $item->id }}" data-jenis="Ubah">
                                                                ...
                                                                <button type="button" data-toggle="tooltip"
                                                                    ...
                                                                    data-id="{{ $item->id }}" data-jenis="hapus">
            ...
            $(document).ready(function() {
                $.getJSON('list-toko', function(data) {
                    ...
                    function alert() {
                        ...
                        var state = 'warning';
                        content.message =
                            'Anda belum memiliki toko, Silakan daftarkan toko anda terlebih dahulu.';
